...
class ReplayBuffer:
    ...
    def sample(self, n):
        ...
        return torch.tensor(state, dtype=torch.float), torch.tensor(action), torch.tensor(reward, dtype=torch.float), torch.tensor(done, dtype=torch.int), torch.tensor(next_state, dtype=torch.float)
